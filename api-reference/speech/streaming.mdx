...
<Note>
The durations array resets its start time for each chunk of audio and there is a 0.45 second silence appended to the end of each chunk of audio that is 
